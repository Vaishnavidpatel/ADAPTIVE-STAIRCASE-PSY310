...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/vaishnavipatel/Library/Mobile Documents/com~apple~CloudDocs/Downloads/Adaptive_Staircase_Vaishnavi_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    staircase = data.StairHandler(startVal=10.0, extraInfo=expInfo,
        stepSizes=[2,1,1,0.5], stepType='log',
